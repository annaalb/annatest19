...
annatest19Hists::annatest19Hists(Context & ctx, const string & dirname): Hists(ctx, dirname){
...
void annatest19Hists::fill(const Event & event){
...
annatest19Hists::~annatest19Hists(){}
